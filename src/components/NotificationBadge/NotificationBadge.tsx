...
export const NotificationBadge = ({ size, hasBadge, badgeColor }: Props) => {
  const hoverStyle = {
    borderRadius: '50%',
  ...
  return (
    <>
      {hasBadge ? (
        <Box _hover={hoverStyle} width={'fit-content'} cursor={'pointer'}>
          <Icon viewBox="0 0 32 32" boxSize={size}>
            <path
            ...
            <path
              ...
              fill={badgeColor ? badgeColor : '#D61E27'}
            />
          </Icon>
        </Box>
      ) : (
